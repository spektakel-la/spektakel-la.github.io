export const en = {
  ...
  program: {
    ...
    liveNow: 'Live now',
    timeUntil: 'to',
    showArtistInfo: 'Show quick info',
    hideArtistInfo: 'Close quick info',
    moreAboutArtist: 'More about',
  ...
  footer: {
    ...
    machineReadableDataLink: 'Machine-readable data and LLM information',
  },
  sponsors: {
    title: 'Our sponsors',
    tagline:
